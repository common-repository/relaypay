...
use RelayPayDeps\Wpify\Model\Attributes\Column;
use RelayPayDeps\Wpify\Model\Exceptions\KeyNotFoundException;
use RelayPayDeps\Wpify\Model\Exceptions\PrimaryKeyException;
use RelayPayDeps\Wpify\Model\Exceptions\RepositoryNotInitialized;
use RelayPayDeps\Wpify\Model\Exceptions\SqlException;
...
abstract class CustomTableRepository extends Repository
{
    ...
    public function migrate() : void
    {
        ...
        if (!\function_exists('RelayPayDeps\\dbDelta')) {
