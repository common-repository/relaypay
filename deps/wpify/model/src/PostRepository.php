...
use RelayPayDeps\Wpify\Model\Exceptions\CouldNotSaveModelException;
use RelayPayDeps\Wpify\Model\Exceptions\IncorrectRepositoryException;
...
class PostRepository extends Repository
{
    ...
    {
        return \boolval(wp_delete_post($model->id, \true));
    }
    /**
