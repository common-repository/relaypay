...
namespace RelayPayDeps\DI\Compiler;

use function chmod;
use RelayPayDeps\DI\Definition\ArrayDefinition;
use RelayPayDeps\DI\Definition\DecoratorDefinition;
...
use RelayPayDeps\DI\Definition\Source\DefinitionSource;
use RelayPayDeps\DI\Definition\StringDefinition;
use RelayPayDeps\DI\Definition\ValueDefinition;
use RelayPayDeps\DI\DependencyException;
use RelayPayDeps\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use RelayPayDeps\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
